resource "aws_vpc_security_group_ingress_rule" "this" {
  ...
  cidr_ipv6                    = lookup(var.ingress_rules[count.index], "cidr_ipv6", null)
  prefix_list_id               = lookup(var.ingress_rules[count.index], "prefix_list_id", null)
  referenced_security_group_id = lookup(var.ingress_rules[count.index], "referenced_security_group_id", null)
